...
#
# Generated by export_simulation on Fri Aug 14 02:10:33 +0800 2020
#
################################################################################
...
./blk_mem_gen_hidden_layer_weight_65x10.sh
...
'-reset_run' switch to the './blk_mem_gen_hidden_layer_weight_65x10.sh' script.

./blk_mem_gen_hidden_layer_weight_65x10.sh -reset_run
...
./blk_mem_gen_hidden_layer_weight_65x10.sh -noclean_files

For more information on the script, please type './blk_mem_gen_hidden_layer_weight_65x10.sh -help'.
